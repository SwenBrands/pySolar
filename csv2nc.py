...
dir_figs = home+'/datos/tareas/proyectos/pticlima/radiation/results/data' #path to output figures file generated by this script
...
rsds.attrs['source_short'] = 'AEMET station data'
