...
for do in np.arange(len(domain)):
    ...
    for yy in np.arange(len(years)):
        ...
        nc_out_day[variable_out].attrs['temporal_aggregation'] = accumulation_day #overwrite detailed temporal aggregation metadata with the metadata generated above for daily values
