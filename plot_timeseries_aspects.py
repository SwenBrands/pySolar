...
#loop through domains and variables
for do in np.arange(len(domain)):
    for vv in np.arange(len(variable)):
        ...
        if file_style == 'yearly': #read all yearly files in <dir_dataset>
            filename_in = dir_dataset+'/'+variable[vv]+'_'+hour_label+'_'+dataset+'_'+domain[do]+'*.nc'
            ...
            filename_in = dir_dataset+'/'+domain[do]+'/'+hour_label+'/'+variable[vv]+'/'+variable[vv]+'_'+hour_label+'_'+dataset+'_'+domain[do]+'_'+str(years[0])+'0101T00_'+str(years[-1])+'1231T23.nc'
